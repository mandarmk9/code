...
N_out2 = 75 #the number of time steps after which an output file is written after a=1
C = 0.5 #the courant factor for the run
loc2 = '/vol/aibn31/data1/mandar/data/test_L1/'

# r_ind = 5 #the index of the file you want to restart the run from
# restart = 1
# try:
...
# ax.plot(x_cell0, M0_nbody, c='b', ls='dotted', lw=2, label=r'N-body')
