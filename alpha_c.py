...
Lambdas = np.arange(2, 12, 2)
for l in range(len(Lambdas)):
   Lambda = Lambdas[l] * (2 * np.pi)
...
ax.plot(Lambdas_inv, alpha_c_true_list, c='blue', lw=2, label=r'from matching $P^{N\mathrm{-body}}$')
...
plt.savefig('../plots/results/alpha_c_scale_dep.png'.format(Lambda), bbox_inches='tight', dpi=120)
plt.close()
